...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "raid:view": "View raids",
  "raid:create": "Create raids",
  "raid:edit": "Edit raids and review proof",
  "raid:export": "Export raid participants",
  "ping:view": "View pings",
  "ping:create": "Create pings",
  "ping:edit": "Edit and schedule pings",
