...
export default async function AdminOrgsPage() {
  ...
  return (
    <>
      <PageTitle
        title="Organizations"
        subtitle="Every community on the platform."
      />
      ...
      <div className="mb-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatCard
          label="Members"
          value={orgs.reduce((a, o) => a + o._count.members, 0)}
        />
      </div>
          ...
          <tbody>
              ...
              <tr key={o.id}>
                <td className="px-4 py-3">
                  ...
                  <Link
                    ...
                    className="text-xs text-kos-muted hover:text-kos-fg"
                  >
                    /{o.slug}
                  </Link>
                </td>
                <td className="px-4 py-3 text-kos-muted">
                  {o.owner.globalName ?? o.owner.username}
                </td>
                <td className="px-4 py-3">
            ...
            {orgs.length === 0 ? (
              <tr>
                <td
                  colSpan={7}
                  className="px-4 py-8 text-center text-kos-muted"
                >
