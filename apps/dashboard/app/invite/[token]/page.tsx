...
export default async function InvitePage({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-5">
      <div className="w-full max-w-sm rounded-2xl border border-kos-border bg-kos-panel/60 p-5 text-center backdrop-blur-xl sm:p-8">
        {invalid ? (
          <>
          ...
          <>
            ...
            <p className="mt-1 text-sm text-kos-muted">
              ...
              <strong className="text-kos-fg">{invite!.role.name}</strong>.
            </p>
            <AcceptInvite
              token={params.token}
